...
CREATE TABLE `items` (
  ...
  INDEX idx_01(`status`,`created_at`),
  INDEX idx_02(`status`,`category_id`,`created_at`),
  INDEX idx_03(`seller_id`,`status`,`created_at`),
  INDEX idx_04(`buyer_id`,`status`,`created_at`)
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8mb4;
